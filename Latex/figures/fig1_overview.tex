% fig1_overview.tex — Dimensional Misalignment Overview (TikZ)
...
\begin{tikzpicture}[scale=0.82, every node/.style={scale=0.82},
  ...
  % ===== (a) Left panel: Dimensional Misalignment Problem =====
  ...
  % Panel (a) title
  \node[above=0.2cm of panelA.north, font=\sffamily\bfseries] {(a) Dimensional Misalignment Problem};
